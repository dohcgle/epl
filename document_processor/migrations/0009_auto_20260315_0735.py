...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('document_processor', '0008_financialinfo_aloqa_ish_tel_and_more'),
    ]
...
BEGIN
    ...
    INSERT INTO document_processor_financialinfo (
        ...
        tahminiy_tolov, majburiyatlar, filial_nomi, filial_boshligi, 
        ...
        (v_financial->>'tahminiy_tolov')::BIGINT, v_financial->>'majburiyatlar', 
    ...
    ON CONFLICT (application_id) DO UPDATE SET
        ...
        tahminiy_tolov = EXCLUDED.tahminiy_tolov, majburiyatlar = EXCLUDED.majburiyatlar, filial_nomi = EXCLUDED.filial_nomi,
...
$$ LANGUAGE plpgsql;
""",
            reverse_sql="DROP FUNCTION IF EXISTS sp_save_loan_application(JSONB, INT, INT);"
        )
    ]
