...
class UmumiyMalumotForm(forms.Form):
    ...
    qarz_oluvchi_fish = forms.CharField(label="Qarz oluvchi F.I.Sh", max_length=255, required=True)
    qarz_oluvchi_pasport_seriya = forms.CharField(label="Pasport seriyasi va raqami", max_length=20, required=True)
    qarz_oluvchi_pasport_berilgan = forms.CharField(label="Kim tomonidan va qachon berilgan", widget=forms.Textarea(attrs={'rows': 2}), required=True)
    qarz_oluvchi_manzil = forms.CharField(label="Doimiy yashash manzili", widget=forms.Textarea(attrs={'rows': 2}), required=True)
    qarz_oluvchi_ish_joyi = forms.CharField(label="Ish joyi va lavozimi", widget=forms.Textarea(attrs={'rows': 2}), required=False)
    qarz_oluvchi_daromad = forms.IntegerField(label="O'rtacha oylik daromad (so'm)", widget=forms.TextInput, required=False)
    qarz_oluvchi_xarajatlar = forms.IntegerField(label="O'rtacha oylik xarajatlar (so'm)", widget=forms.TextInput, required=False)
    ...
    qarz_oluvchi_tahminiy_tolov = forms.IntegerField(label="Mikroqarz bo‘yicha oylik differensial to‘lovi miqdori (tahminiy)", widget=forms.TextInput, required=False)
    ...
    kredit_miqdori = forms.IntegerField(label="Kredit miqdori (raqam bilan)", widget=forms.TextInput, required=False)
    ...
    kredit_muddat_oy = forms.CharField(label="Kredit muddati (oy)", initial="12", required=False)
    foiz_stavkasi = forms.CharField(label="Foiz stavkasi (raqam)", initial="55", required=False)
    ...
    garov_egasi_fish = forms.CharField(label="Garov egasi F.I.Sh", max_length=255, required=False)
    ...
    avto_bahosi = forms.IntegerField(label="Baholangan qiymati", widget=forms.TextInput, required=False)
    ...
    mulk_bahosi = forms.IntegerField(label="Kelishilgan garov qiymati (raqam)", widget=forms.TextInput, required=False)
    ...
    tilla_bahosi = forms.IntegerField(label="Baholangan qiymati", widget=forms.TextInput, required=False)
    ...
    sugurta_summasi = forms.IntegerField(label="Sug'urta summasi (raqam)", widget=forms.TextInput, required=False)
